   ...
   // let timer = SKLabelNode(text: " ")
        ...
        if(StartGame){
            ...
            wasted.removeFromParent()
                ...
                if currentTime > creationTime {
                    ...
                    createZombieAnchor()
                    creationTime = currentTime + TimeInterval(randomFloat(min: 0.5, max: 1.0))
            ...
            if currentTime > gameTime {
                ...
                gameTime = currentTime + TimeInterval(randomFloat(min: 1.0, max: 1.0))
            ...
            if currentTime > HealthTime {
                ...
                HealthCount = HealthCount - 5
                HealthTime = currentTime + TimeInterval(randomFloat(min: 2.0, max: 3.0))
                
            }
            
            
        
        if(HealthCount <= 50 && HealthCount >= 22){
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if(KillsCount > 35) {
                        ...
                        let firstScene = Portal(fileNamed: "Portal")
