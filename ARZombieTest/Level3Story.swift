...
class Level3Story: SKScene {
    ...
    let StoryLabel1 = SKLabelNode(text: "We finally got the first gem..!!")
    let StoryLabel2 = SKLabelNode(text: "One more to go..")
    let StoryLabel3 = SKLabelNode(text: "But this will not be that easy")
    let StoryLabel4 = SKLabelNode(text: "as last mission..")
    
    
    // Secene 2
    let Page2 = SKLabelNode(text: "the infection is spreading like")
    let Page21 = SKLabelNode(text: "wild fire.. we cannot stay longer outside.")
    let Page22 = SKLabelNode(text: "if you loose the health you get infected")
    let Page23 = SKLabelNode(text: "and zombies are getting harder to kill")
    let Page24 = SKLabelNode(text: "as they get immune to bullets.. ")
    
    // Scene 3
    let Page3 = SKLabelNode(text: "Hello citizens...")
    let Page31 = SKLabelNode(text: "things are getting worse")
    let Page32 = SKLabelNode(text: "please be safe and help each other")
    let Page33 = SKLabelNode(text: "its getting difficult for use to control")
    let Page34 = SKLabelNode(text: "the situation...")
    ...
    let Page43 = SKLabelNode(text: "2. look for  the 2nd gem..")
